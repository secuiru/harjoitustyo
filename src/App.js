...
function App() {
  ...
  function searchFunction(){
    ...
    .then((response)=>{
     ...
     /*drinkslist[1] = response.data.drinks[1].strDrink
     drinkslist[2] = response.data.drinks[2].strDrink
     drinkslist[3] = response.data.drinks[3].strDrink
     drinkslist[4] = response.data.drinks[4].strDrink*/
  ...
  return (
    ...
    <p onChange={getIngredients}></p>
      ...
      <p>search results</p>
      <p>{drinklist[0]}<button type="button"onClick={getIngredients}>More</button></p>
      <p>{drinklist[1]}</p>
      <p>{drinklist[2]}</p>
      <p>{drinklist[3]}</p>
      <p>{drinklist[4]}</p>
